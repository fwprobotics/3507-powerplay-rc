...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.917;
    ...
    public void turnRelativeSync(double angle)
    {
        ...
        //pMode.telemetry.log().add("inputted Angle: " + angle + " , turning to: " + target);
    ...
    public void setAngle(double offset) {
        ...
        setPoseEstimate(new Pose2d(currentPos.getX(), currentPos.getY(), getRawExternalHeading() + offset));
    }

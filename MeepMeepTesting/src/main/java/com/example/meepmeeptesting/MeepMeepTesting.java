...
//new Pose2d(32, -66, Math.toRadians(90))
                    ...
                    FieldTrajectorySequence fieldTrajectorySequence = field.createFieldTrajectory(new Pose2d(29.5, -67, Math.toRadians(90)))
                        //    .toPole(false, true)
//                            .toStack(false)
...
//                           // .toStack(false)
                           // .toPole(2, -1, FieldTrajectorySequence.sides.UP, false, false)
                           // .toStack(false)
                            .toPole(2, -1, -90, false, true, new Pose2d(-2.5, 1.5))
                            .turn(90)
                            .toStack(false, 0)
                            .toPole(2, -1, -90, false, true, new Pose2d(-2.5, 1.5))
                            .turn(90)
